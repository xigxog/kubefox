...
func (x *brokerSubscribeClient) Send(m *core.Event) error {
	return x.ClientStream.SendMsg(m)
}

func (x *brokerSubscribeClient) Recv() (*core.MatchedEvent, error) {
	m := new(core.MatchedEvent)
...
func (x *brokerSubscribeServer) Send(m *core.MatchedEvent) error {
	return x.ServerStream.SendMsg(m)
}

func (x *brokerSubscribeServer) Recv() (*core.Event, error) {
	m := new(core.Event)
