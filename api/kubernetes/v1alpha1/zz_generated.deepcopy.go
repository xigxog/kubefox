...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReleaseManifestApp) DeepCopyInto(out *ReleaseManifestApp) {
	*out = *in
	in.AppDeployment.DeepCopyInto(&out.AppDeployment)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReleaseManifestApp.
func (in *ReleaseManifestApp) DeepCopy() *ReleaseManifestApp {
	if in == nil {
		return nil
	}
	out := new(ReleaseManifestApp)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReleaseManifestAppDep) DeepCopyInto(out *ReleaseManifestAppDep) {
	*out = *in
	in.Spec.DeepCopyInto(&out.Spec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReleaseManifestAppDep.
func (in *ReleaseManifestAppDep) DeepCopy() *ReleaseManifestAppDep {
	if in == nil {
		return nil
	}
	out := new(ReleaseManifestAppDep)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ReleaseManifestSpec) DeepCopyInto(out *ReleaseManifestSpec) {
	*out = *in
	...
	if in.Apps != nil {
		in, out := &in.Apps, &out.Apps
		*out = make(map[string]*ReleaseManifestApp, len(*in))
		for key, val := range *in {
			var outVal *ReleaseManifestApp
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
