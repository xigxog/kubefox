...
func (in *ReleaseManifestAdapters) DeepCopyInto(out *ReleaseManifestAdapters) {
	*out = *in
	if in.HTTPAdapters != nil {
		...
		*out = make([]ReleaseManifestHTTPAdapter, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReleaseManifestHTTPAdapter) DeepCopyInto(out *ReleaseManifestHTTPAdapter) {
	*out = *in
	out.ObjectRef = in.ObjectRef
	in.Spec.DeepCopyInto(&out.Spec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReleaseManifestHTTPAdapter.
func (in *ReleaseManifestHTTPAdapter) DeepCopy() *ReleaseManifestHTTPAdapter {
	if in == nil {
		return nil
	}
	out := new(ReleaseManifestHTTPAdapter)
	in.DeepCopyInto(out)
	return out
}
