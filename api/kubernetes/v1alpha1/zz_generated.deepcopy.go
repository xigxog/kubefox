...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeploymentApp) DeepCopyInto(out *DeploymentApp) {
	*out = *in
	out.App = in.App
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeploymentApp.
func (in *DeploymentApp) DeepCopy() *DeploymentApp {
	if in == nil {
		return nil
	}
	out := new(DeploymentApp)
	in.DeepCopyInto(out)
	return out
}
